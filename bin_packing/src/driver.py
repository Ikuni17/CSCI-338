...
generate_file("squares.txt", 1, 1000, 2000)
...
solve_problem("data/1.in")
solve_problem("data/2.in")
#solve_problem("data/3.in")
#solve_problem("data/4.in")

'''data_files = 70
total_improvement = 0
for i in range(1, data_files + 1):
    solve_problem("data/" + str(i) + ".in")'''
